...
const TimeBar = ({ leftTime, initialTime }: TimeBarProps) => {
  ...
  return (
    <div className="h-11 w-272 bg-[#8A8A8A] w-full rounded-full overflow-hidden">
      <div
...
export default function DuoMatchedStatus() {
  let initialTime = 20;
    ...
    <div className="w-307 h-546 bg-secondary-realdarkgray pt-18 px-10 rounded-12 flex flex-col items-center">
      <div className="flex flex-col gap-24 items-center w-full">
        ...
        <div className="flex gap-6">
          <button className="w-140 py-8 flex-1 bg-red-600 text-primary-white text-body1-16-bold rounded-10 hover:bg-red-500">
            매칭 거절
          </button>
          <button className="w-140 py-8 flex-1 bg-secondary-green text-primary-white text-body1-16-bold rounded-10 hover:bg-primary-green">
            매칭 수락
          </button>
        </div>
      </div>
